  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-2.384185791015625e-7 0.5 115 115">
      <g fill="#a238ff">
        ...
        <path d="m100.804 7.99168-.004-.00001h.008z" />
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                    {discography.map((item, i) => (
                        ...
                        >
                            ...
                            <div
                                className="absolute inset-0 flex items-center justify-center gap-5 bg-background/25 backdrop-blur-md opacity-0 pointer-events-none transition-opacity duration-300
